...
const homeContent: Record<Language, HomeContent> = {
  en: {
    hero: {
      ...
      primaryHref: "https://refpa3665.com/L?tag=d_4092175m_66329c_MLBEgypt26",
      secondary: "Explore sports",
      secondaryHref: "https://refpa3665.com/L?tag=d_4092175m_66329c_Egyptsport",
      ...
      rails: [
        {
          ...
          image: "/home/sports/basketball.webp",
          metric: "Fast",
        },
        {
          eyebrow: "Tennis",
    ...
    offers: {
      ...
      cards: [
        ...
        },
        {
          ...
          image: "/home/gifts/cashback.webp",
          metric: "Cashback",
        },
      ],
    },
    finalCta: {
      ...
      body: "Message the support team on Telegram or email for quick help with getting started, games, or available offers.",
      primary: "Telegram",
      primaryHref: "https://t.me/EGYPT_TEAMCASH",
      secondary: "Email",
      secondaryHref: "mailto:PAYPARTNERS-EGYPT@MELBET.COM",
    },
    footer: {
  ...
  ar: {
    ...
    finalCta: {
      ...
      body: "راسل فريق الدعم عبر تيليجرام أو البريد الإلكتروني لتحصل على رد سريع حول البداية أو الألعاب أو العروض المتاحة.",
      primary: "تيليجرام",
      primaryHref: "https://t.me/EGYPT_TEAMCASH",
